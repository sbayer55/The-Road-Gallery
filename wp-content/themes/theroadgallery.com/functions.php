...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size( 'grid', 320, 320, true ); //sidbar thumbs, 50x50, no hard-crop
    ...
    add_image_size('custom-size', 800, 320, true); // Custom Thumbnail Size call using the_post_thumbnail('custom-size');
...
add_action('init', 'homeslider_init');
function homeslider_init() {
    $labels = array(
        'name' => _x('Homepage Slides (1400px by 700px please for best viewing!', 'post type general name'),
        'singular_name' => _x('Slide', 'post type singular name'),
        'add_new' => _x('Add New', 'slide'),
        'add_new_item' => __('Add New Slide 1400px by 700px!!!'),
...
/* Register a Custom Post Type (Artist) */
...
/* Register a Custom Post Type (HP Blurb) */
add_action('init', 'blurb_init');
function blurb_init() {
    $labels = array(
        'name' => _x('Blurb Homepage', 'post type general name'),
        'singular_name' => _x('Blurb', 'post type singular name'),
        'add_new' => _x('Add New', 'Blurb'),
        'add_new_item' => __('Add New Blurb'),
        'edit_item' => __('Edit Blurb'),
        'new_item' => __('New Blurb'),
        'view_item' => __('View Blurb'),
        'search_items' => __('Search Blurb'),
        'not_found' => __('No Blurb found'),
        'not_found_in_trash' => __('No Blurb found in Trash'),
        'parent_item_colon' => '',
        'menu_name' => 'Homepage Blurb'
    );
    $args = array(
        'labels' => $labels,
        'public' => true,
...
/* Register a Custom Post Type (HP News) */
add_action('init', 'news_init');
function news_init() {
    $labels = array(
        'name' => _x('News Homepage', 'post type general name'),
...
/* Register a Custom Post Type (Footer) */
